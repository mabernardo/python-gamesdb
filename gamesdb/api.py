...
class Game(object):
    ...
    def __init__(self, id, title, release_date=None, platform=None,
            overview=None, esrb_rating=None, genres=None, players=None,
            coop=None, youtube_url=None, publisher=None, developer=None,
            rating=None, logo_url=None):
        self.id = id
        self.title = title
...
class GamesDB(object):
    ...
    def get_platforms_list():
        ...
        for element in xml_response.iter(tag="Platform"):
            ...
            platforms_list.append(Platform(
                platform_id, platform_name, alias=platform_alias))
    ...
    def get_platform(id):
        ...
        if platform_id is None or platform_name is None:
            raise APIException("get_platform returned a result without"
                "required fields id or platform")

        return Platform(platform_id, platform_name, console=platform_console,
            controller=platform_controller, graphics=platform_graphics,
            max_controllers=platform_max_controllers, rating=platform_rating,
            display=platform_display, manufacturer=platform_manufacturer,
            cpu=platform_cpu, memory=platform_memory, sound=platform_sound,
        ...
        for element in xml_response.iter(tag="Game"):
            ...
            for subelement in element:
                ...
                if subelement.tag == 'ReleaseDate':
                    # platform_games_list_release_date = datetime.strptime(
                    #    subelement.text, "%m/%d/%Y")
            ...
            platform_games_list.append(Game(
                platform_games_list_id, platform_games_list_name,
    ...
    def get_game(id=None, name=None, platform=None):
        ...
        for element in xml_response.iter(tag="Game"):
            ...
            for subelement in element:
                ...
                if subelement.tag == 'Genres':
                    ...
                    for genre_element in subelement.iter(tag="genre"):
                        game_genres.append(genre_element.text)
            ...
            games_list.append(Game(
                game_id, game_title, release_date=game_release_date,
                platform=game_platform, overview=game_overview,
                esrb_rating=game_esrb_rating, genres=game_genres,
                players=game_players, coop=game_coop,
                youtube_url=game_youtube_url, publisher=game_publisher,
                developer=game_developer, rating=game_rating,
